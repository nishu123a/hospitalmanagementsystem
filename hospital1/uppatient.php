...
<?php
    ...
    if(isset($_POST['daddp'])){
        ...
        $q="UPDATE register SET Name = '$_POST[name]',Age='$_POST[age]',Mobile='$_POST[phone]',Password='$_POST[password]',Gender='$_POST[gender]' WHERE Email = '$email'";
      ...
      <form action="uppatient.php" method='post'>
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="gender" name="gender" placeholder="Enter Gender" required>
          </div>
        </div>
