...
if($row>0){
    echo "  <center style='width:400px;left:50%;position:absolute;top:50%;border-radius:10px; background: linear-gradient(to bottom, #66ccff 0%, #3333cc 100%);transform:translate(-50%,-50%)'>
            <h1 style='text-align:center;padding:0px 0px 20px 0px;color:#00004d;'> Welcome Admin<h1> 

            <form action='manage.php' method='POST'style='padding:0px 40px;box-sizing:border-box;'>
            <table style='padding: 0 20px 30px;'>
                <tr>
                    <td>
                    <input type='submit' value='Manage Doctors' name='donorm' style='background:#00004d;color:wheat;border-radius:30px;padding: 10px  30px'>
                    </td>
                </tr>
                <tr>
                    <td>
                    <input type='submit' value='Manage patients' name='requestm' style='background:#00004d;color:wheat;border-radius:30px;padding: 10px  30px'>
                    </td>
                </tr>
                <tr>
                <td>
                <input type='submit' value='Manage nurses' name='rem' style='background:#00004d;color:wheat;border-radius:30px;padding: 10px  30px'>
                </td>
            </tr>
    ...
    <head>
      ...
      <body>
        ...
        <br><br>
        <center><form action='alogin.php' method='post'> <input type='submit' value ='Go to Login Page' style='color: white;padding: 15px 32px;text-align: center;text-decoration: none;font-size: 16px;margin: 4px 2px;border-radius: 10px;background-color:#004280;border:none;border-bottom: 2px solid black;'> </form></center>
        </div>
      </body>
  </html>";
}
