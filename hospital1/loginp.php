...
$query="select * from patientlogin where Email='$email' and Password='$password'";
...
if($row>0){
    ...
    <h1 style='text-align:center;padding:0px 0px 20px 0px;color:#00004d;'> Welcome Patient<h1> 

    <form action='uppatient.php' method='POST'style='padding:0px 40px;box-sizing:border-box;'>
    <table style='padding: 0 20px 30px;'>
        ...
        <form action='Registration.php' method='POST'style='padding:0px 40px;box-sizing:border-box;'>

        <tr>
        <td>
        <input type='submit' value='Book My Appointment' name='rem' style='background:#00004d;color:wheat;border-radius:30px;padding: 10px  30px'>
        </td>
    </tr>
</table>
    </form>
    ...
    <head>
      ...
      <body>
        ...
        <br><br>
        <center><form action='patientlogin.php' method='post'> <input type='submit' value ='Go to Login Page' style='color: white;padding: 15px 32px;text-align: center;text-decoration: none;font-size: 16px;margin: 4px 2px;border-radius: 10px;background-color:#004280;border:none;border-bottom: 2px solid black;'> </form></center>
        </div>
      </body>
  </html>";
}
